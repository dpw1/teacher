              ...
              <div className="section__title registerarea__section__title">
                ...
                <div className="section__title__heading heading__underline">
                  <h2>
                    ...
                    <span>
                      <a href="https://wa.me/5511994873187">
                        <small>Whatsapp</small>
                      </a>
                    </span>
                    ,{" "}
                    <span>
                      <a href="https://www.instagram.com/psicopedagoga.patyfortes">
                        <small>Instagram</small>
                      </a>
                    </span>{" "}
                    ou{" "}
                    <span>
                      <a href="mailto:patriciacasorla@gmail.com">
                        <small>e-mail</small>
                      </a>
                    </span>
                    .
                ...
                <div className="Contact-item">
                  ...
                  <div className="Contact-text">
                    <a
                      ...
                      target="_blank"
                      href="https://wa.me/5511994873187">
                      +55 11 9 9487 3187
                    </a>
                  </div>
                </div>
                <div className="Contact-item">
                  ...
                  <div className="Contact-text">
                    <a
                      className="button-hover"
                      target="_blank"
                      href="https://www.instagram.com/psicopedagoga.patyfortes">
                      @psicopedagoga.patyfortes
                    </a>
                  </div>
                </div>
                <div className="Contact-item">
                  ...
                  <div className="Contact-text">
                    <a
                      className="button-hover"
                      target="_blank"
                      href="mailto:patriciacasorla@gmail.com">
                      patriciacasorla@gmail.com
                    </a>
                  </div>
                </div>
              </div>
